...
# --- Funkce pro načítání dat (beze změny) ---
def get_data_stats(base_path, num_files=20):
    ...
    for i in range(num_files):
        ...
        try:
            ...
            pass # Tiché přeskočení pro čistší výstup
...
# --- ÚPRAVA DAT (CUT & SHIFT) ---
# Všechna data proženeme funkcí, která vyhodí 100-150 a zbytek posune
...
# --- Referenční čára (Classical Robot) ---
# I referenční čáru musíme "posunout". 
# Původně: [0, 150, 150, 500] -> Skok byl na 150.
# Nově: Skok je na 100 (150-50).
x_points = [0, 100, 100, 450] # Posunuto o 50
...
# Vertikální čára označující změnu (nyní na 100 místo 150)
ax.axvline(x=100, color='black', linestyle=':', linewidth=1.5, alpha=0.6)
ax.text(100 + 30, 180, 'WM and / or Goal position change', fontsize=14)

# ==========================
# Vykreslení upravených dat
# ==========================

# 4. DATA: Novelty (Zelená)
...
# 3. SCENÁŘ: Combined Change (Červená)
...
# Upravené limity osy X
# Původně jsi chtěl do 250. Protože jsme 50 uřízli, nový konec je 200.
ax.set_xlim(0, 200)
ax.set_ylim(0, 205)
