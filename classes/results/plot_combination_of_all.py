...
paths_2 = {
    "cur": "/Users/jakubmuller/Desktop/WORK/iwinac2026/results_data/cur_wm_"
    # "nov" was commented out in original script 2
}
paths_3 = {
    "cur": "/Users/jakubmuller/Desktop/WORK/iwinac2026/results_data/cur_comb_"
...
ax.text(150 + 5, 205, 'Goal position change', fontsize=14)
...
ax.plot(x_points, y_points, color='red', linestyle='-', alpha=0.4, label='Predefined Setup')
ax.axvline(x=150, color='black', linestyle='--', linewidth=1.5, alpha=0.6)
ax.text(150 + 5, 205, 'World Model change', fontsize=14)
...
ax.plot(x_points, y_points, color='red', linestyle='-', alpha=0.4, label='Predefined Setup')
ax.axvline(x=150, color='black', linestyle='--', linewidth=1.5, alpha=0.6)
ax.text(150 + 5, 205, 'WM & Goal position change', fontsize=14)
...
for i, ax in enumerate(axes):
    ...
    if i == 0:
        ax.set_ylabel("Steps", fontsize=14) # Only label Y on the first plot
...
plt.tight_layout()
plt.savefig("/Users/jakubmuller/Desktop/WORK/iwinac2026/plot_ijrc_next.png", dpi=300)
plt.show()