...
base_path_nov = "/home/citic_gii/sim/results_data/nov_wm_"
steps_data_cur = {}
steps_data_nov = {}
...
plt.text(150 + 2, 205, 'World Model change', fontsize=12)
...
plt.legend()
plt.tight_layout()
plt.savefig("/home/citic_gii/sim/plot_ijrc_wm.png", dpi=300)
plt.show()